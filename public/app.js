...
`,
    ...
    function addStartTeachingCTA() {
      // هنضيف الزر تحت آخر فقاعة من النظام (اللي فيها التقرير)
      ...
      startBtn.className = "tool-btn";
      startBtn.textContent = (currentLang === "ar" ? "ابدأ الشرح" : "Start explanation");
